          ...
          <div class="collapse          navbar-collapse"    id="navbarNavDropdown">  <! –– Nav Bar can collapse like a drop down button ––> 
               ...
               <ul class="navbar-nav    ms-auto"> 
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item   active" href="Medicines.php">Medicines</a>
...
<!------------------------------------------------------- Upper Part ------------------------------------------------------->
  ...
  <div class="container">
    ...
    <h1 class="text-center" >Medicine Stock Management</h1>

    <a href="Functions_Medicines/Create_Medicine.php" class='btn btn-outline-dark mb-2'> <i class="bi bi-eyedropper"></i> Add New Medicine</a>
    ...
    <table class="table   table-striped   table-bordered    table-hover">
      ...
      <tbody>
        <tr>
          ...
          <?php
              $query="SELECT * FROM medicine";               // SQL query to fetch all table data
              $view_medicine= mysqli_query($conn,$query);    // sending the query to the database
              ...
              while($row= mysqli_fetch_assoc($view_medicine))
              {
                ...
                echo " <td class='text-center'> <a href='Functions_Medicines/View_Medicine.php?user_id={$id}' class='btn btn-primary'> <i class='bi bi-eye'></i> View</a> </td>";

                echo " <td class='text-center' > <a href='Functions_Medicines/Edit_Medicine.php?edit&user_id={$id}' class='btn btn-secondary'><i class='bi bi-pencil'></i> Edit</a> </td>";

                echo " <td  class='text-center'>  <a href='Functions_Medicines/Delete_Medicine.php?delete={$id}' class='btn btn-danger'> <i class='bi bi-trash'></i> Delete</a> </td>";
                echo " </tr> ";           
              }  
            ?>
